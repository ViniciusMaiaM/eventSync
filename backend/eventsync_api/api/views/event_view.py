...
class EventListView(APIView):
    ...
    @extend_schema(
        ...
        parameters=[
            ...
            OpenApiParameter(
                name="status", description="Event status", required=False, type=str
            ),
            OpenApiParameter(
                name="event_type", description="Event type", required=False, type=str
            ),
            OpenApiParameter(
                name="name", description="Event name", required=False, type=str
            ),
        ],
    )
...
class UserOrganizedEventsView(APIView):
    ...
    def get(self, request, format=None):
        ...
        events = (
            events.filter(
                registrationpresence__user=user, registrationpresence__type="organizer"
            )
            .distinct()
            .order_by("id")
        )
