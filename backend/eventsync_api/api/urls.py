...
from .views import thematic_room_view as trview
...
urlpatterns = [
    ...
    path(
        "sponsors/<int:pk>/", spview.SponsorDetailView.as_view(), name="sponsor_detail"
    ),
    path(
        "sponsorships/", spsview.SponsorShipListView.as_view(), name="sponsorship_list"
    ),
    path(
        "sponsorships/<int:pk>/",
        spsview.SponsorShipDetailView.as_view(),
        name="sponsorship_detail",
    ),
    path("forms/", formview.FormsRegisterList.as_view(), name="form_list"),
    path(
        "forms/<int:pk>/", formview.FormsRegisterDetail.as_view(), name="forms_detail"
    ),
    ...
    path(
        "events/registration/",
        rpview.RegistrationPresenceList.as_view(),
        name="event_registration_list",
    ),
    path(
        "events/registration/<int:event_id>/<int:user_id>/",
        rpview.RegistrationPresenceDetail.as_view(),
        name="event_registration_detail",
    ),
    path(
        "eventsorganized/",
        evtview.UserOrganizedEventsView.as_view(),
        name="events_organized",
    ),
    path(
        "eventspresence/",
        evtview.UserPresentEventsView.as_view(),
        name="events_presence",
    ),
    path(
        "organizer/<int:event_id>/", rpview.OrganizerDetail.as_view(), name="organizer"
    ),
    path(
        "participants/<int:event_id>/",
        rpview.EventParticipantsList.as_view(),
        name="participants",
    ),
    path(
        "thematic-rooms/",
        trview.ThematicRoomListView.as_view(),
        name="thematic_room_list",
    ),
    path(
        "thematic-rooms/<int:pk>/",
        trview.ThematicRoomDetailView.as_view(),
        name="thematic_room_detail",
    ),
]
